  ...
  return (
    <section id="prizes" className="bg-white text-black py-20">
      <div className="max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
          {prizes.map((prize) => (
            <div key={prize.rank} className="flex flex-col items-center">
              <span className="text-black text-xl font-bold mb-3">{prize.rank}</span>
        ...
        {/* 일본 견학 */}
        <div className="mt-14 border border-black/10 rounded-2xl p-1 flex flex-col md:flex-row items-center gap-5 text-left">

    ...
    <main className="font-sans">
      ...
      <section className="relative overflow-hidden bg-[#0d0d14] text-white">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-32 text-center">
          <div className="inline-block mb-6 px-4 py-1.5 rounded-full border border-violet-500/40 bg-violet-500/10 text-violet-300 text-xs font-medium tracking-widest uppercase">
            KIROTHON
          </div>
          ...
          <p className="text-gray-400 text-lg md:text-xl mb-10 max-w-xl mx-auto leading-relaxed">
            ...
            <span className="text-violet-300 font-medium">AWS Kiro 기반 &apos;AI 자동 개발&apos; 해커톤</span>
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="#apply"
              className="px-8 py-3.5 bg-violet-600 hover:bg-violet-500 rounded-full font-semibold transition-colors text-sm"
            >
              지금 신청하기
            </a>
            <a
      ...
      <section id="timeline" className="bg-white py-20">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-16">전체 추진 일정</h2>
          ...
          <div className="max-w-3xl mx-auto space-y-0">
            {[
              ...
              },
              {
                period: "5/15 – 21",
                label: "사전 기술 교육",
                desc: "온라인 Kiro 환경 세팅, 사전 과제 및 질의응답",
                color: "bg-violet-200 text-violet-800 border-violet-300",
                dot: "bg-violet-400",
              },
              {
                period: "5/22 – 23",
                label: "KIROTHON 예선",
                desc: "1박 2일 몰입 개발 (금 10시 – 토 18시), 본선 진출 우수 4팀 선발",
              ...
              },
              {
                period: "5/17 – 31",
                label: "프로젝트 고도화",
                desc: "전문가 온라인 밀착 멘토링, 앱 오류 수정 및 품질 향상",
                color: "bg-violet-100 text-violet-700 border-violet-200",
                dot: "bg-violet-300",
              },
              {
                period: "6/03",
                label: "경진대회 본선",
                desc: "최종 완성된 서비스 발표, 최종 우수 2팀 선발 및 시상",
              ...
              },
              {
                period: "7/06 ~",
                label: "일본 글로벌 견학",
                desc: "최종 2팀 도쿄 IT 기업 탐방 (3박 4일), 글로벌 IT 트렌드 직접 체험",
                color: "bg-amber-400 text-amber-900 border-amber-400",
                dot: "bg-amber-400",
              },
            ].map((item, i) => (
              <div key={item.label} className="flex gap-6">
                {/* Left: period + dot + line */}
                <div className="flex flex-col items-center w-28 shrink-0">
                  <div className={`w-3 h-3 rounded-full mt-1.5 ${item.dot}`} />
                  {i < 5 && <div className="w-px flex-1 bg-gray-200 my-1" />}
                </div>
                {/* Right: content */}
                <div className="pb-10">
                  <div className={`inline-block px-3 py-1 rounded-full text-xs font-semibold mb-2 border ${item.color}`}>
                    {item.period}
                  </div>
      ...
      <section id="prizes" className="bg-gray-50 py-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-4 max-w-4xl mx-auto mb-10">
            {[
              { rank: "대상", icon: "🥇", amount: "100만원", team: "1팀", highlight: true },
              { rank: "최우수상", icon: "🥈", amount: "80만원", team: "1팀", highlight: false },
              { rank: "우수상", icon: "🥉", amount: "50만원", team: "1팀", highlight: false },
              { rank: "장려상", icon: "🎖️", amount: "30만원", team: "1팀", highlight: false },
            ].map((prize) => (
              <div
                key={prize.rank}
                className={`rounded-2xl p-6 text-center border transition-shadow hover:shadow-lg ${
                  prize.highlight
              ...
              >
                ...
                <div className={`text-xs font-semibold uppercase tracking-widest mb-1 ${prize.highlight ? "text-violet-200" : "text-gray-400"}`}>
                  {prize.rank}
                </div>
                <div className={`text-2xl font-extrabold mb-1 ${prize.highlight ? "text-white" : "text-gray-900"}`}>
                  {prize.amount}
                </div>
                <div className={`text-xs ${prize.highlight ? "text-violet-200" : "text-gray-400"}`}>{prize.team}</div>
              </div>
            ))}
          </div>
          ...
          <div className="max-w-4xl mx-auto rounded-2xl bg-[#0d0d14] text-white p-8 flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="text-amber-400 text-xs font-bold uppercase tracking-widest mb-2">부상 · 대상 + 최우수상 2팀 (최대 10명)</div>
      ...
      <section id="judging" className="bg-white py-20">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-16">KIROTHON 특화 심사 기준</h2>

          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {[
              {
                pct: "30%",
                title: "Prompt / Spec Quality",
                desc: "KIRO를 논리적으로 가이드하여 완성도 높은 명세(Spec)를 뽑아내었는가?",
              ...
              },
              {
                ...
                desc: "단순 챗봇이 아닌, 스스로 과업을 수행하는 'Agent' 성격이 서비스에 묻어나는가?",
              ...
              },
              {
                pct: "20%",
                title: "Campus Impact",
                desc: "대학 생활의 문제(AI Campus)를 얼마나 창의적이고 실용적으로 해결했는가?",
              ...
              },
              {
                pct: "20%",
                title: "Completeness",
                desc: "KIRO를 활용해 실제 인프라에 배포 및 동작 가능한 수준으로 완성했는가?",
                color: "border-amber-400",
                bg: "bg-amber-50",
              },
            ].map((item) => (
      ...
      <section id="apply" className="bg-[#0d0d14] text-white py-24">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <a
            href="#"
            className="inline-block px-10 py-4 bg-violet-600 hover:bg-violet-500 rounded-full font-bold text-lg transition-colors"
          >
            참가 신청하기 →
          </a>
        </div>

...
const timeline = [
  { period: "3월 – 4월", label: "준비 및 모집", desc: "행사 준비 및 참가팀 선발, 대회 일정 안내", dot: "bg-indigo-900" },
  { period: "5/15 – 21", label: "사전 기술 교육", desc: "온라인 Kiro 환경 세팅, 사전 과제 및 질의응답", dot: "bg-indigo-900" },
  { period: "5/22 – 23", label: "KIROTHON 예선", desc: "1박 2일 몰입 개발 (금 10시 – 토 18시), 본선 진출 우수 4팀 선발", dot: "bg-indigo-900" },
  { period: "5/17 – 31", label: "프로젝트 고도화", desc: "전문가 온라인 밀착 멘토링, 앱 오류 수정 및 품질 향상", dot: "bg-indigo-900" },
  { period: "6/03", label: "경진대회 본선", desc: "최종 완성된 서비스 발표, 최종 우수 2팀 선발 및 시상", dot: "bg-indigo-900" },
  { period: "7/06 ~", label: "일본 글로벌 견학", desc: "최종 2팀 도쿄 IT 기업 탐방 (3박 4일), 글로벌 IT 트렌드 직접 체험", dot: "bg-indigo-900" },
];
  ...
  return (
    <main className="font-sans">
      ...
      <section id="timeline" className="bg-white py-20">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-16">전체 일정</h2>
          ...
          <div className="max-w-3xl mx-auto space-y-0">
            {timeline.map((item, i) => (
              <div key={item.label} className="flex gap-6">
                ...
                {/* Right: content */}
                <div className="pb-10">
                  <div className="inline-block text-sm font-bold mb-2 text-indigo-900">
                    {item.period}
                  </div>
                  <h3 className="font-bold text-base mb-1 text-gray-900">{item.label}</h3>
